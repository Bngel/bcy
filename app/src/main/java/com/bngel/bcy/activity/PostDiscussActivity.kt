...
class PostDiscussActivity : BaseActivity() {
    ...
    private val postService = CosControllerService()
    ...
    private fun sendEvent() {
        send_btn_PostDiscussActivity.setOnClickListener {
            val description = content_PostDiscussActivity.text.toString()
            if (description == "") {
                ...
                val postAcgCos = postService.postAcgCos(description, InfoRepository.user.id, labelList, permission, imageList)
                if (postAcgCos != null) {
                    when (postAcgCos.msg) {
                        "success" -> {
    ...
    private fun uploadEvent() {
        image_btn_PostDiscussActivity.setOnClickListener {
    ...
    private fun permissionEvent() {
        more_btn_PostDiscussActivity.setOnClickListener {
    ...
    private fun tagEvent() {
        tags_PostDiscussActivity.setOnClickListener {
    ...
    private fun displayImage(imageUri: Uri) {
        ...
        val result = postService.postAcgCosPhotoUpload(part)
        when (result?.msg) {
            "success" -> {
                ...
                Glide.with(this)
                    ...
                    .into(image)
                photos_PostDiscussActivity.addView(image)
